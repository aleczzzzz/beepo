...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    Route::get('tasks/download/xls', [TaskController::class, 'downloadXLS'])->name('tasks.download.xls');
    Route::get('tasks/download/csv', [TaskController::class, 'downloadCSV'])->name('tasks.download.csv');
    ...
    Route::post('tasks/{task}/update-position', [TaskController::class, 'updatePosition']);
